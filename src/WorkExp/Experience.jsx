...
function Experience () {
  return (
    <div>
        ...
        <div>
          <div>
            <h2>04/2017 –  08/2018</h2>  
            <h2>International Relations Office, University of Sarajevo - Intern</h2> 
          ...
          <div>
            <h2>02 – 06/2019</h2>  
            <h2>Wifirst UK - Marketing manager intern, London</h2>
          ...
          <div>
            <h2>08/19 – Currently</h2>
            <h2>Saudi Arabian Airlines - Executive Assistant to Regional Manager </h2>
