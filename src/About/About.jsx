  ...
  return (
    ...
    <div>
      ...
      <div className='contact-grid'>
          ...
          <a className='contact-info' href="https://drive.google.com/file/d/1ZrXLDdgTFSvvx_iLhFHrqlgjLevJ2e3Q/view?usp=sharing" target='_blank' rel='noreferrer'><i className="fa-solid fa-file-lines fa-fw"></i>CV</a>
      </div>
    </div>
